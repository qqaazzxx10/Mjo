...
async def join_channel(event):
    try:
        await sython1(JoinChannelRequest("@DaythonSource"))
...
async def join_channel(event):
    try:
        await sython1(JoinChannelRequest("@xqx_xx"))
    except BaseException:
        pass
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        await event.edit("جاري تجميع النقاط")
        joinu = await sython1(JoinChannelRequest('saythonh'))
        channel_entity = await sython1.get_entity('@xDamKombot')
        await sython1.send_message('@xDamKombot', '/start')
        await asyncio.sleep(4)
        msg0 = await sython1.get_messages('@xDamKombot', limit=1)
        await msg0[0].click(1)
        await asyncio.sleep(4)
        msg1 = await sython1.get_messages('@xDamKombot', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    await sython1(ImportChatInviteRequest(bott))
                msg2 = await sython1.get_messages('@xDamKombot', limit=1)
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        await sython1.send_message('@xDamKombot', '/start')
        await asyncio.sleep(4)
        msg0 = (await sython1.get_messages('@xDamKombot', limit=1))[0]
        msg_text = msg0.message
        points_line = [line for line in msg_text.split('\\n') if 'نقاطك' in line][0]
        points = int(points_line.split(':')[1].strip())
        msg1 = (await sython1.get_messages('@xDamKombot', limit=1))[0]
        await msg1.click(4)
        await sython1.send_message('@xDamKombot', f'{user}')
        
        await sython1.send_message('@xDamKombot', f'{points}')
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        await asyncio.sleep(4)
        msg1 = await sython1.get_messages('@xDamKombot', limit=1)
        await sython1.send_message('@xDamKombot', f'{cod}')
